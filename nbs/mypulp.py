...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/15mypulp.ipynb.

# %% auto 0
__all__ = ['TEST', 'quicksum', 'GRB', 'gray', 'convex_comb_agg_log', 'mult_selection', 'multidict', 'tuplelist', 'LinExpr',
           'Variable', 'Model']

# %% ../nbs/15mypulp.ipynb 4
TEST = False
import math
import sys
import pulp
...
# %% ../nbs/15mypulp.ipynb 8
def gray(i):
    return i ^ i // 2

# %% ../nbs/15mypulp.ipynb 9
